...
public interface XLSConstants {
    ...
    String DEFAULT_BASIC_INFO_SHEET_PASSWORD = "123456";
    String DEFAULT_BASIC_INFO_SHEET_ERROR_TITLE = "DEFAULT_BASIC_INFO_SHEET_ERROR_TITLE";
    String DEFAULT_BASIC_INFO_SHEET_ERROR_MESSAGE = "DEFAULT_BASIC_INFO_SHEET_ERROR_MESSAGE";
    String BASIC_INFO_SHEET_NAME="BasicInformationForExcelSheet";
    ...
    String INVALID_EMPTY_PASSWORD = "INVALID_EMPTY_PASSWORD";
}
